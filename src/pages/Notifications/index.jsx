          ...
          <div className="bg-white-A700 flex flex-col items-center justify-start md:ml-[0] ml-[978px] mr-6 p-3 md:px-5 rounded-[15px] w-[31%] md:w-full">
            <div className="flex flex-col gap-[30px] items-center justify-start mb-2 w-full">
              <div className="flex sm:flex-col flex-row sm:gap-5 items-start justify-start rounded-[5px] w-[95%] md:w-full">
                ...
                <Button
                  className="bg-transparent black_900_0e_black_900_29_border cursor-pointer min-w-[89px] sm:ml-[0] ml-[109px] outline outline-[1px] text-center text-xs"
                  shape="round"
                  color="white_A700_b2"
                  size="md"
                >
                ...
                <Button
                  className="bg-transparent black_900_0e_black_900_29_border2 cursor-pointer min-w-[89px] ml-3.5 sm:ml-[0] outline outline-[1px] text-center text-xs"
                  shape="round"
                  color="white_A700_b2"
                  size="md"
                >
              ...
              >
                <div className="flex flex-1 flex-col justify-start w-full">
                    ...
                    <div className="flex flex-col items-center justify-start w-[99%] md:w-full">
                      ...
                      <div className="flex flex-col items-start justify-start mt-1">
                        ...
                        <Text
                          ...
                          size="txtGilroyRegular15Gray500"
                        >
                  ...
                  <Text
                    className="md:ml-[0] ml-[355px] mt-[3px] text-[15px] text-gray-900"
                    size="txtGilroyRegular15Gray900"
                  >
                    6:00 PM
                  </Text>
                </div>
