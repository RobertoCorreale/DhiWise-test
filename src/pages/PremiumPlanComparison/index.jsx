        ...
        <div className="flex flex-col gap-[50px] items-center justify-start max-w-[1246px] mb-[191px] mx-auto pt-3 md:px-5 w-full">
          ...
          <div className="flex flex-col gap-[30px] items-center justify-start w-full">
            <div className="flex flex-row gap-6 items-center justify-center w-[16%] md:w-full">
              <Button
                className="cursor-pointer font-semibold min-w-[87px] text-center text-lg"
                shape="round"
                size="xl"
              >
                Monthly
            ...
            >
              <div className="bg-white-A700 flex flex-1 flex-col gap-[50px] items-center justify-start p-8 sm:px-5 rounded-md shadow-bs2 w-full">
                ...
                <Button
                  className="cursor-pointer font-medium min-w-[230px] rounded-md text-base text-center"
                  shape="round"
                >
                  Create account
                </Button>
              ...
              <div className="bg-white-A700 flex flex-1 flex-col gap-[50px] items-center justify-start p-8 sm:px-5 rounded-md shadow-bs2 w-full">
                ...
                <Button
                  className="!text-blue_gray-400 cursor-pointer font-medium min-w-[230px] rounded-md text-base text-center"
                  shape="round"
                  color="blue_gray_400"
                  variant="outline"
                >
