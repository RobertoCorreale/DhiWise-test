        ...
        <div className="flex md:flex-col flex-row gap-7 items-start justify-start md:px-5 w-[95%] md:w-full">
          ...
          <div className="flex flex-1 flex-col gap-[42px] items-center justify-start md:mt-0 mt-8 w-full">
            ...
            <div className="flex flex-col gap-6 items-center justify-start w-full">
              <div className="bg-gray-50 flex flex-col gap-3 h-[196px] md:h-auto items-center justify-center max-w-[1022px] outline outline-[2px] outline-blue-A700_01 sm:px-5 px-8 py-[15px] rounded-md w-full">
                <Img
                ...
                <Button
                  className="cursor-pointer flex items-center justify-center min-w-[96px] rounded-md"
                  leftIcon={
                    <Img
              ...
              >
                <div className="flex flex-1 flex-col gap-2 items-start justify-start w-full">
                  <div className="flex md:flex-col flex-row gap-[7px] items-center justify-between w-full">
                    ...
                    <Button
                      className="cursor-pointer font-medium min-w-[53px] rounded-md text-center text-sm"
                      size="xl"
                      variant="outline"
                    >
                      Print
