  ...
  return (
    <>
      <div className="bg-gray-50 flex flex-col font-gilroy gap-[50px] items-center justify-end mx-auto w-full">
        ...
        <div className="bg-white-A700 flex flex-col items-center justify-end max-w-[1120px] mx-auto pt-[30px] md:px-5 px-[30px] rounded-md shadow-bs w-full">
                  ...
                  <div className="flex flex-col items-center justify-start">
                    <div className="flex flex-col items-start justify-start w-full">
                      ...
                      <div className="flex flex-row sm:gap-10 items-end justify-between mt-[18px] w-full">
                        ...
                        <Button
                          className="cursor-pointer font-gilroy font-semibold mb-[5px] mt-2.5 rounded-md text-base text-center w-[164px]"
                          shape="round"
                        >
                          Move to cart
                        </Button>
                        ...
                        <div className="flex flex-col font-opensans gap-[17px] items-start justify-start">
                          ...
                          <div className="flex flex-row gap-[15px] items-end justify-between w-full">
                            ...
                            >
                              ...
                              <span className="text-colors5 font-opensans font-semibold">
                                555.29
                              </span>
                            </Text>
                            <Text
