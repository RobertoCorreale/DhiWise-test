    ...
    <>
      <div className="bg-gray-50 flex flex-col font-gilroy sm:gap-10 md:gap-10 gap-[70px] items-center justify-start mx-auto pb-[294px] w-full">
        ...
        <div className="flex md:flex-col flex-row gap-7 items-start justify-start max-w-[1268px] mx-auto md:px-5 w-full">
          <div className="bg-white-A700 flex md:flex-1 flex-col gap-[31px] items-start justify-start p-4 rounded-lg shadow-bs1 w-[68%] md:w-full">
            <Input
              name="Group1541"
          ...
          <div className="bg-white-A700 flex md:flex-1 flex-col gap-8 items-center justify-start mb-[257px] p-4 rounded-lg shadow-bs1 w-[31%] md:w-full">
