                ...
                <div className="bg-white-A700 flex flex-col items-start justify-start p-4 rounded-lg w-full">
                  <div className="flex flex-row items-start justify-between w-full">
                    <Img
                      ...
                      src="images/img_2560pxstripel.png"
                      alt="2560pxStripeL"
                    />
                    <Switch
                      onColor="#0061ff"
                  ...
                  <div className="flex flex-col gap-2 items-start justify-start mt-7">
                    <Text
                  ...
                  <Button
                    className="cursor-pointer font-medium mt-4 rounded-md text-center text-sm w-[342px]"
                    size="md"
                  >
                    Generate Key
                  </Button>
