        ...
        <div className="flex md:flex-col flex-row gap-7 items-start justify-start max-w-[1268px] mx-auto md:px-5 w-full">
          <div className="flex md:flex-1 flex-col gap-[50px] items-center justify-start w-[49%] md:w-full">
            ...
            <div className="flex md:flex-col flex-row gap-4 items-center justify-between rounded-md w-full">
              <Button
                className="cursor-pointer font-medium rounded-md text-center text-lg w-[300px]"
                size="3xl"
                variant="outline"
              >
                Add to Cart
              </Button>
              <Button className="cursor-pointer font-medium rounded-md text-center text-lg w-[300px]">
                Buy Now
              </Button>
            </div>
          </div>
          <div className="flex md:flex-1 flex-col items-start justify-start w-1/2 md:w-full">
            ...
            >
              <span className="md:text-[26px] sm:text-2xl text-colors2 font-gilroy text-left text-[28px] font-semibold italic">
                $499
              </span>
              <span className="text-colors2 font-gilroy text-left font-fw italic">
                {" "}
              </span>
              <span className="text-colors3 font-gilroy text-left text-base font-semibold line-through italic">
                $599
              </span>
            </Text>
            ...
            >
              <div className="flex flex-col items-center justify-start w-full">
                <div className="flex flex-col gap-2 items-center justify-start rounded-[12px] w-full">
                  ...
                  <Text
                    className="leading-[22.00px] text-center text-gray-800_01 text-sm"
                    size="txtGilroyMedium14Gray80001"
                  >
                    <>
                      100% <br />
                      Authentic
            ...
            >
              <span className="text-colors6 font-gilroy text-left font-bold">
                About this item
              </span>
              ...
              <span className="text-colors3 font-gilroy text-left font-medium">
                <>
                  ...
                  with Dual LED Flash; 16MP Front (Selfie) Camera with Sony
                  IMX471
                  <br />
                  ...
                  navigate, and more, all using just your voice, while
                  on-the-go.
                  <br />
                  Show Less
                </>
